...
listItems.forEach((data)=>list.insertAdjacentHTML("beforeend", `<div>과일명 : ${data.name}, 수량 : ${data.cnt}</div>`));

// 심심하면 장바구니 표현하는 거 table로 출력해주고... 해당 페이지에서 수량 변경 가능하게 그리고 삭제까지 등등등 심심하면 해보라심 ㄷㄷ